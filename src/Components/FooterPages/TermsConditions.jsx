...
const TermsConditions = () => {
    return (
      ...
      <div className="text-sm breadcrumbs px-5 md:px-10 mt-5">
        ...
        <p className='text-gray-700 mb-5'>This privacy policy governs your use of the website, Web Application & MEDLIFEEASY App("Application") for web & mobile devices.</p>
        </div>
